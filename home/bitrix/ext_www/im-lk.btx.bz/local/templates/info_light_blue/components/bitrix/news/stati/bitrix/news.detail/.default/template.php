...
<?$file = CFile::ResizeImageGet($arResult['PREVIEW_PICTURE']['ID'], array('width'=>90, 'height'=>59), BX_RESIZE_IMAGE_PROPORTIONAL, true);?>
<h1><?=$arResult['NAME']?></h1>
<div class="g-page-article__top-panel">
    <div class="g-page-article__date">Дата публикации: <?=$arResult['TIMESTAMP_X']?></div>
</div>
<div class="g-page-article__image">
    <a class="highslide" href="<?=$arResult['PREVIEW_PICTURE']['SRC']?>" onclick="return hs.expand(this);">
        <img src="<?=$file['src']?>" alt="В каких случаях делается УЗИ печени и как подготовиться к процедуре" title="В каких случаях делается УЗИ печени и как подготовиться к процедуре">
    </a>
</div>
