...
$APPLICATION->SetTitle("Направления клиники");
$APPLICATION->SetPageProperty("description", "Направления клиники «Иммунитет» - Дневного стационара и лаборатории");
?> <?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"CHECK_DATES" => "Y",
		"SEF_MODE" => "Y",
		"SEF_FOLDER" => "/napravleniya-kliniki/",
		"AJAX_MODE" => "N",
		...
		"PAGER_TITLE" => "Направления клиники",
		"PAGER_SHOW_ALWAYS" => "Y",
