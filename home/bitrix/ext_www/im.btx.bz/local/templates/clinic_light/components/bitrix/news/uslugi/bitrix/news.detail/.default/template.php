...
$APPLICATION->SetPageProperty("title", "Получить к32ю консультацию, диагностическое обследование, результативное лечение. Медицинская клиника, диагностический центр Иммунитет в г. Бронницы - ваш верный выбор!");
...
<div class="new-table">
    <div class="new-table-el">
		<a href="/kontakty" class="bk1"><img alt="logogo" class="seo_img" height="30"
                                                         src="/d/490268/d/logogo.png" width="30"> Связаться с
                        нами</a>
	</div>
 	<div class="new-table-el">
		<a href="/stoimost-uslug" class="bk1"><img alt="logogo" class="seo_img" height="30"
                                                               src="/d/490268/d/logogo.png" width="30"> Узнать
                        стоимость</a>
	</div>
 	<div class="new-table-el">
		<a href="/napravleniya-kliniki" class="bk1"><img alt="logogo" class="seo_img" height="30"
                                                                     src="/d/490268/d/logogo.png" width="30"> Наши
                        направления</a>
	</div>
</div>
        <div class="zagalovok5">Обращайтесь и уточняйте детали записи по телефону, указанному на сайте!</div>
        <br clear="all"><br>
	...
	<div class="news-detail-back"><a href="/uslugi/"><?=GetMessage("T_NEWS_DETAIL_BACK")?></a></div>
	<?
