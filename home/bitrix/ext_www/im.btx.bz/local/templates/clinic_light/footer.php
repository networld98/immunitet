...
<? if ($APPLICATION->GetCurPage() === '/stati/' || $APPLICATION->GetCurPage() == '/podgotovka-k-analizam/' || $APPLICATION->GetCurPage() == '/osnovnyye-trebovaniya-podgotovki-patsiyenta-k-analizu-mochi/' || $APPLICATION->GetCurPage() == '/funktsionalnyye-proby/' || $APPLICATION->GetCurPage() === '/issledovaniya-krovi-na-nalichiye-infektsiy/' || $APPLICATION->GetCurPage() == '/sbor-mochi-dlya-mikrobiologicheskogo-issledovaniya/' || $APPLICATION->GetCurPage() === '/osnovnyye-trebovaniya-podgotovki-patsiyenta-k-analizu-kala/' || $APPLICATION->GetCurPage() == '/osnovnyye-trebovaniya-podgotovki-patsiyenta-k-ptsr-diagnostike/'){?>
<div class="pulse-line"></div>
<div class="footer-article small-screen-padding">
    <div class="footer-article-inner">
        <?$APPLICATION->IncludeFile("/include/footer_article.php", Array(), Array(
            "MODE"      => "php",
...
<div class="fs-popup" style="display: none;">
    <div class="fs-popup__inner">
        <div class="fs-wrapper">
            ...
            <div class="fs-message" style="display: none;"><div class="fs-message__svg"><img class="fs-message__ico" alt="Лого" src="/thumb/2/Gzc6c-7LqnoggZkMnHEdlQ/60r60/d/svg2-logo.svg"></div><div class="fs-thanks">Администратор медицинского центра перезвонит Вам для уточнения даты, времени заявки и вашей контактной информации в течение часа.</div></div>
        </div>
    </div>
</div>
<!-- #footer -->
...
<noscript><div><img src="https://mc.yandex.ru/watch/28124256" style="position:absolute; left:-9999px;" alt="yandex" /></div></noscript>
<!-- /Yandex.Metrika counter -->
