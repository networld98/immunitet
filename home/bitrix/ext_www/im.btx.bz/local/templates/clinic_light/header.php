...
<!--    <link href="--><?//=SITE_TEMPLATE_PATH?><!--/css/articles.css" rel="stylesheet">-->
    ...
    <link type="text/css" rel="stylesheet" href="<?=SITE_TEMPLATE_PATH?>/css/custom.css"/>
...
<body class="<?if ($APPLICATION->GetCurPage() == '/index/'){?>page-main<?}elseif($APPLICATION->GetCurPage() == '/detskoe-otdelenie1/'){?>page-children<?}elseif($APPLICATION->GetCurPage() =='/napravleniya-kliniki/'){?>page-service-list<?}elseif(CSite::InDir('/napravleniya-kliniki/')){?>page-service<?}?>">
<div id="site-wrapper">
<!--    <div class="wrapper-shadow left"></div>-->
<!--    <div class="wrapper-shadow right"></div>-->
    <header id="header" role="banner">
        <div class="logo">
            <?$APPLICATION->IncludeFile("/include/infoportal_name_clinic.php", Array(), Array(
                "MODE"      => "php",
                "NAME"      => "Редактирование включаемой области раздела",
                "TEMPLATE"  => "section_include_template.php"
            ));?>
        </div>
        <?$APPLICATION->IncludeFile("/include/main_menu_clinic.php", Array(), Array(
            "MODE"      => "php",
            "NAME"      => "Редактирование включаемой области раздела",
            "TEMPLATE"  => "section_include_template.php"
        ));?>
