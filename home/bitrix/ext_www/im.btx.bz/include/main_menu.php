<nav class="top_menu_wrap">
    <ul class="top_menu small-screen-padding">
        <li><a class="piejs text-shadow" href="/o-kompanii" >О центре
            </a>
            <ul>
        ...
        <li><a class="piejs text-shadow" href="/patsiyentam" >Пациентам
            </a>
            <ul>
        ...
        <li><a class="piejs text-shadow" href="/zapis-na-priyem">Запись на приём
            </a>
        </li>
        <li><a class="piejs text-shadow has-icon" href="http://imm.clinic/" target="_blank">Анализы
